...
<html>
	<head>
		...
		<title>PapyrusRequirementProvider OSLC Adapter: Service Provider Catalog</title>
		<%-- 
		...
		<div id="header">
			...
			<table border="0" cellspacing="0" cellpadding="0" id="titles">
				<tr>
					<td id="title">
						<p>
							ServiceProviderCatalogSingleton: Service Provider Catalog
						</p>
					</td>
					<td id="information">
...
End of user code 
			...
			<p>The Service Provider Catalog</p>
...
End of user code 
	            ...
	            <tr>
		            ...
		            <td>PapyrusRequirementProvider</td>
	            </tr>
            </table>
