...
public class ServiceProvidersFactory
{
           ...
           throws OslcCoreApplicationException, URISyntaxException
    {
        ...
        final PrefixDefinition[] prefixDefinitions =
        {
			...
			new PrefixDefinition(PapyrusRequirementProviderConstants.DUBLIN_CORE_NAMSPACE_PREFIX, new URI(PapyrusRequirementProviderConstants.DUBLIN_CORE_NAMSPACE))
,
			new PrefixDefinition(PapyrusRequirementProviderConstants.FOAF_NAMSPACE_PREFIX, new URI(PapyrusRequirementProviderConstants.FOAF_NAMSPACE))
,
			new PrefixDefinition(PapyrusRequirementProviderConstants.OSLC_CORE_NAMSPACE_PREFIX, new URI(PapyrusRequirementProviderConstants.OSLC_CORE_NAMSPACE))
,
			new PrefixDefinition(PapyrusRequirementProviderConstants.REQUIREMENT_MANAGEMENT_NAMSPACE_PREFIX, new URI(PapyrusRequirementProviderConstants.REQUIREMENT_MANAGEMENT_NAMSPACE))
        };
