...
public class ServiceProviderCatalogSingleton
{
    ...
    static
    {
        try
        {
            ...
            serviceProviderCatalog.setTitle("ServiceProviderCatalogSingleton");
            serviceProviderCatalog.setDescription("The Service Provider Catalog");
            serviceProviderCatalog.setPublisher(new Publisher("invalid", "invalid"));
            serviceProviderCatalog.getPublisher().setIcon(new URI("invalid"));
        }
