...
@OslcSchema ({
	...
	@OslcNamespaceDefinition(prefix = PapyrusRequirementProviderConstants.DUBLIN_CORE_NAMSPACE_PREFIX, namespaceURI = PapyrusRequirementProviderConstants.DUBLIN_CORE_NAMSPACE),
	@OslcNamespaceDefinition(prefix = PapyrusRequirementProviderConstants.FOAF_NAMSPACE_PREFIX, namespaceURI = PapyrusRequirementProviderConstants.FOAF_NAMSPACE),
	@OslcNamespaceDefinition(prefix = PapyrusRequirementProviderConstants.OSLC_CORE_NAMSPACE_PREFIX, namespaceURI = PapyrusRequirementProviderConstants.OSLC_CORE_NAMSPACE),
	@OslcNamespaceDefinition(prefix = PapyrusRequirementProviderConstants.REQUIREMENT_MANAGEMENT_NAMSPACE_PREFIX, namespaceURI = PapyrusRequirementProviderConstants.REQUIREMENT_MANAGEMENT_NAMSPACE)
})
